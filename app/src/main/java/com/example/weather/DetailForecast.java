...
public class DetailForecast extends AppCompatActivity {
    TextView tv_date, tv_maxtemp, tv_avgtemp, tv_mintemp, tv_maxwind, tv_totalprecip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_maxwind = findViewById(R.id.tv_maxwind);
        tv_totalprecip = findViewById(R.id.tv_totalprecip);

        tv_date.setText("Date : "+forecastDay.getDate());
        tv_maxtemp.setText("Maximum Temperature : "+Double.toString(forecastDay.getDay().getMaxtemp_c())+"°C");
        tv_avgtemp.setText(Double.toString(forecastDay.getDay().getAvgtemp_c())+"°C");
        tv_mintemp.setText("Minimum Temperature : "+Double.toString(forecastDay.getDay().getMintemp_c())+"°C");
        tv_maxwind.setText("Maximum Wind Speed: "+Double.toString(forecastDay.getDay().getMaxwind_kph())+" KPH");
