        ...
        ApiClient.endpoint().getData()
                .enqueue(new Callback<WeatherModel>() {
                    ...
                    public void onResponse(Call<WeatherModel> call, Response<WeatherModel> response) {
                        ...
                        tv_wind.setText("Wind : "+Double.toString(response.body().getCurrent().getWind_kph())+" KPH");
                        tv_pressure.setText("Pressure : "+Double.toString(response.body().getCurrent().getPressure_mb())+" Milibar");
                        tv_precip.setText("Precipitation : "+Double.toString(response.body().getCurrent().getPrecip_mm())+" Milimeter");
                        ...
                        tv_gust.setText("Gust : "+Double.toString(response.body().getCurrent().getGust_kph())+" KPH");
